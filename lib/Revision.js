...
Revision.fromJSON = function (json, ottype) {
  ...
  if (json.content) {
    if (ottype.deserialize) r.content = ottype.deserialize(json.content);else r.content = json.content;
  }
  return r;
};
...
Revision.prototype.toJSON = function (withContent) {
  ...
  if (withContent && this.content) {
    if (this.ottype.serialize) o.content = this.ottype.serialize(this.content);else o.content = this.content;
  }
  return o;
};

Revision.prototype.serialize = function (withContent) {
  return (0, _stringify2.default)(this.toJSON(withContent));
};
