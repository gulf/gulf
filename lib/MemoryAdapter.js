...
MemoryAdapter.prototype.getLastRevision = function (docId) {
  if (!this.history.length) return _promise2.default.resolve();
  var o = this.snapshots[this.history[this.history.length - 1]];
...
MemoryAdapter.prototype.existsRevision = function (docId, editId) {
  return _promise2.default.resolve(!!this.snapshots[editId]);
};
...
MemoryAdapter.prototype.getRevisionsAfter = function (docId, editId) {
  ...
  return _promise2.default.resolve(arr);
};