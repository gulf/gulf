...
MemoryAdapter.prototype.earliestEdit = function(cb) {
  if(!this.history.length) return cb()
  cb(null, this.edits[this.history[0]])
}

MemoryAdapter.prototype.latestEdit = function(cb) {
  if(!this.history.length) return cb()
  cb(null, this.edits[this.history[this.history.length-1]])
}

MemoryAdapter.prototype.pushEdit = function(edit, cb) {
...
MemoryAdapter.prototype.remembersEdit = function(editId, cb) {
