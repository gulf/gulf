...
History.prototype.storeSnapshot = function(snapshot, cb) {
  ...
  this.latest(function(er, latest) {
    ...
    this.document.adapter.storeSnapshot({id: snapshot.edit.id, changes: snapshot.edit.changeset, parent: snapshot.edit.parent, contents: snapshot.contents}, function(er) {
      cb && cb(er)
    })
  }.bind(this))
}
